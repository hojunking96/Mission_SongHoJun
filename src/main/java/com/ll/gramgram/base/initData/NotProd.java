...
public class NotProd {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            ...
            Member memberUser5ByKakao = memberService.whenSocialLogin("KAKAO", "KAKAO__2734892248").getData();
            Member memberUser6ByGoogle = memberService.whenSocialLogin("GOOGLE", "GOOGLE__108357099011765832817").getData();
