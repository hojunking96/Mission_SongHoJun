    ...
    CommandLineRunner initData(
        ...
        return new CommandLineRunner() {
            ...
            public void run(String... args) throws Exception {
                ...
                Member memberUser6ByKakao = memberService.whenSocialLogin("KAKAO", "KAKAO__2734892248").getData();
                Member memberUser7ByGoogle = memberService.whenSocialLogin("GOOGLE", "GOOGLE__108357099011765832817").getData();
                Member memberUser8ByNaver = memberService.whenSocialLogin("NAVER", "NAVER__4nkn3QpWLSssjaKyxU66HT34JJvwBVnvDCTd4TFO0l8").getData();
                Member memberUser9ByFacebook = memberService.whenSocialLogin("FACEBOOK", "FACEBOOK__2454135401419866").getData();
